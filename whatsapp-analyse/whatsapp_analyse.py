...
def cli_implementation() -> dict:
    ...
    parser.add_argument("-n", "--notification", action="store_true", help="Obtain data on non-user messages (mainly in group chats) that occur in group chat, like a group's icon was changed")
